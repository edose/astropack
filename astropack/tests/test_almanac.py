...
_____TEST_FUNCTIONS_OUTSIDE_ASTRONIGHT_______________________________________ = 0
...
def test_astronight_attributes_basic():
    ...
    assert an.sf_master_eph.filename == 'de440s.bsp'
    assert str(type(an.sf_timescale)) == '<class \'skyfield.timelib.Timescale\'>'
    ...
    assert (an.timespan_dark.midpoint - Time('2022-02-09 07:16:04.796')).sec == \
           pytest.approx(0, abs=2)
    assert (an.local_middark_utc - Time('2022-02-09 07:16:04.796')).sec == \
           pytest.approx(0, abs=2)
...
def test_astronight_attributes_cases():
    pass
...
def test_moon_illumination_pct():
    an = make_new_astronight()
    mi = almanac.moon_illumination_pct(an.sf_master_eph, an.sf_timescale,
...
def test_target_transit_time():
    ...
    transit = almanac.target_transit_time(an.obs, an.sf_master_eph, an.sf_timescale, sc,
                                          target_time)
...
def test_moon_transit_time():
    an = make_new_astronight()
    mtt = almanac.moon_transit_time(an.obs, an.sf_master_eph, an.sf_timescale,
...
def test_moon_ra_dec():
    an = make_new_astronight()
    ra, dec = almanac.moon_ra_dec(an.obs, an.sf_master_eph, an.sf_timescale,
                                  an.local_middark_utc)
...
_____TEST_SETUP_and_SUPPORT_________________________________________________ = 0
